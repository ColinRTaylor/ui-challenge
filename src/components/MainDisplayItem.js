...
import { removeUnderscores, scrollToSlow } from "../utils";
      ...
      >
        ...
        <div className="card-content left-panel">
          <div className="columns display-section">
            <span className="label left-section column is-one-third">
              Type:
            </span>
            <p className="column right-section title-case"> {data_type}</p>
          </div>
          {
            app_keys.length ? <div className="columns display-section">
                <span className="label left-section column is-one-third">
                  Usage:
                </span>
